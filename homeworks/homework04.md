...
V skripte `h04.py` ďalej nájdete krátky kód, ktorý vygeneruje maticu *5x5* s náhodnými desatinnými číslami. Vašou úlohou je pomocou knižnice `numpy` získať alebo vypočítať požadovaný údaj po riadkoch alebo stĺpcoch (konkrétnu úlohu nájdete v komentároch v `h04.py`).
...
## Deadline
Vaše riešenie nahrajte do 20. 3. 2026 (piatok), do 18:00.

...
| 3. týždeň<br>1. 3. - 7. 3.    | Test 1 ([ukážka](tests/T1-sample.pdf))<br>Zložitosť algoritmov, triedenie a vyhľadávanie           | [Práca so základnými údajovými štruktúrami](labs/lab03-a-look-at-the-table.ipynb)               | DÚ2 odozvdanie<br>DÚ3 publikovaná      |

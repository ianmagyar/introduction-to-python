...
| 11. týždeň<br>27. 4. - 3. 5.  |                [Web scraping](labs/lab10-web-scraping.ipynb)               |                  [Návrhové vzory I](lectures/Lecture-10.pdf)<br>([kód z prednášky](lectures/codes/lecture10.py))                  |                     [Z3 publikované](assignments/Assignment3.zip)                      |
| 12. týždeň<br>4. 5. - 10. 5.  |         [Strojové učenie v Pythone](labs/lab11-introduction-to-ml.ipynb)         |         [Návrhové vzory II](lectures/Lecture-11.pdf)<br>([kód z prednášky](lectures/codes/lecture10.py))          |                                                         |
| 13. týždeň<br>11. 5. - 17. 5. |             [Vývoj hry v pygame](labs/lab12-pygame.ipynb)            |                        *TBA*                        |                      Z3 odovdzávka                      |
...
3. [použitie lambda výrazov a list comprehension](homeworks/homework03.md) (deadline 13. 3. 2026)
4. [numpy a pandas](homeworks/homework04.md) (deadline 20. 3. 2026)
5. [ošetrenie chýb](homeworks/homework05.md) (deadline 27. 3. 2026)

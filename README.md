...
| 12. týždeň<br>1. 5. - 7. 5.   |            [Vývoj hier v Pythone](labs/lab11-pygame.ipynb)           |                   [Vedecké výpočty v Pythone](lectures/Lecture-10.pdf)<br>([kód z prednášky](lectures/codes/lecture10.ipynb))                  |                      D9 odovzdávka                      |

...
|  7. týždeň<br>24. 3. - 30. 3. |           [Monte Carlo simulácie](labs/lab07-monte-carlo-simulations.ipynb)           |            Test 2<br>[Výpočtové modely a simulácia](lectures/Lecture-07.pdf) <br> ([kód z prednášky](lectures/codes/lecture07.zip))            |                      D6 odovzdávka<br>Z2 publikované                      |

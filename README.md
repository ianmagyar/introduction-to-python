...
|  4. týždeň<br>7. 3. - 13. 3.  |        Test1 ([ukážka](tests/T1-sample.pdf))<br>Testovanie, ladenie, výnimky a chyby         | Práca so základnými údajovými štruktúrami |             D3 odovzdávka<br>D4 publikovaná             |
